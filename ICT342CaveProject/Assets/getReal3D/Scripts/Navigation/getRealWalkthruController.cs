...
{
    private CharacterMotorC m_motor;
...
// Use this for initialization
    void Awake()
    {
        ...
        m_motor = GetComponent<CharacterMotorC>();
    ...
    void UpdateNavigation(Vector3 joy, float elapsed)
    {
        ...
        case NavFollows.Wand:
            directionVector = getWand().rotation * directionVector;
            break;
        case NavFollows.Head:
            directionVector = getHead().rotation * directionVector;
            break;
